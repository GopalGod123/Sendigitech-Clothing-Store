...
const Cart = () => {
    const { cartItems, currency, update, updateQuantity, navigate } =
        useContext(ShopContext); // Simplified destructuring
    ...
    useEffect(() => {
        ...
        for (const itemId in cartItems) {
            const itemDetails = cartItems[itemId]; // Get the details of each item
        ...
        setCartData(tempData); // Update the state with the processed data
    }, [cartItems]);
